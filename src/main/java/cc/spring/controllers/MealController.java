...
public class MealController {
	...
	public ResponseEntity<List<MealDTO>> aiMeal(String sendMsg, int dayTime, int timeArrLength) throws Exception {
		
		List<MealDTO> result = mService.makeMeal(sendMsg,dayTime, timeArrLength);
