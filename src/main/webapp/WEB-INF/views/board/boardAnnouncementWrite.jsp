...
<script
	src="https://cdn.jsdelivr.net/npm/summernote@0.8.18/lang/summernote-ko-KR.min.js"></script>
<!--한글지원-->
	...
	<form id="frm" action="/board/inputAnnouncement" method="post">
		...
		<div class="container">
			...
			<div class="body">
				...
				<div>
					제목 : <label><input id="title" name="title"
						class="form-control" placeholder="제목을 입력하세요 (최대 50자까지 가능합니다)"></label>
				</div>
			</div>
