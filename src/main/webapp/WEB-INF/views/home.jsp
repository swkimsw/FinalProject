						...
						<div class="d-flex align-items-center justify-content-center">
							<div class="waitingSpinner m-4" style="display: none;">
								<div class="d-flex justify-content-center">
									<div class="spinner-border text-success m-5" style="width:3rem; height:3rem;"
										role="status">
							...
							<div class="selectBox">
								...
								<div class="d-flex justify-content-center">
									<div class="form-check form-check-inline">
										<input class="form-check-input" type="checkbox" id="breakfast" name="time"
											value="아침"> <label class="form-check-label" for="breakfast">아침</label>
									</div>
									<div class="form-check form-check-inline">
										<input class="form-check-input" type="checkbox" id="lunch" name="time"
											value="점심"> <label class="form-check-label" for="lunch">점심</label>
									</div>
									<div class="form-check form-check-inline">
										<input class="form-check-input" type="checkbox" id="dinner" name="time"
											value="저녁"> <label class="form-check-label" for="dinner">저녁</label>
									</div>
								</div>
								<!-- 비건, 다이어트 -->
								<div class="d-flex justify-content-center">
									...
									<div class="form-check form-check-inline">
										<input class="form-check-input" type="radio" id="general" name="special"
											value="1000" checked> <label class="form-check-label"
											for="general">없음</label>
									</div>
									<div class="form-check form-check-inline">
										<input class="form-check-input" type="radio" id="vigan" name="special"
											value="1001"> <label class="form-check-label" for="vigan">비건</label>
									</div>
									<div class="form-check form-check-inline">
										<input class="form-check-input" type="radio" id="diet" name="special"
											value="1002"> <label class="form-check-label" for="diet">다이어트</label>
									</div>
									<div class="form-check form-check-inline">
										<input class="form-check-input" type="radio" id="viganDiet" name="special"
											value="1003"> <label class="form-check-label" for="viganDiet">비건
											다이어트</label>
									</div>
								</div>
								<div class="d-flex justify-content-center">
									...
									<button type="button" id="aiMealAddBtn" class="btn btn-success btn-lg btn-rounded"
										hidden>저장하기</button>
								</div>
							</div>
										...
										<div class="modal-dialog modal-dialog-centered">
											<div class="modal-content">
												...
												<div class="modal-body">
													<div
														...
														<div class="btnRight-mealList">
															...
															<button type="button" id="delivery"
																class="btn btn-success">배달</button>
														</div>
													</div>
														...
														<div class="row">
															...
															<div class="col-3">
																<button class="btn btn-success w-100 toSearch"
																	data-bs-target="#mealModalToggle2"
																	data-bs-toggle="modal">찾아보기</button>
															</div>
														</div>
													</div>
													<div class="insertBox m-2">
												...
												<div class="modal-footer mx-2">
													<button type="button" id="saveMeal"
														class="btn btn-success">저장하기</button>
												</div>
											</div>
										</div>
									</div>
											...
											<div class="modal-content">
												...
												<div class="modal-footer">
													<button id="toFirstModal" class="btn btn-success"
														data-bs-target="#mealModalToggle"
